...
def _one_hot_encoder(n_classes,input_tensor):
    tensor_list = []
...
def valer_synapse(args, model, snapshot_path):
    ...
    trainloader = DataLoader(db_val, batch_size=batch_size, shuffle=True, num_workers=8, pin_memory=True,
    ...
    with torch.no_grad():
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs = _one_hot_encoder(num_classes,image_batch)
...
parser.add_argument('--root_path', type=str,
                    default='./data/创/4', help='root dir for data')
